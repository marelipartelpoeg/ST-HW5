...
public class GTv1 {
	...
	public void testCreatesNextDate4() throws Throwable {
	    ...
	    String string0 = nextDate0.run(4, 30, 1844);
	    assertEquals("5/1/1844", string0);
	}
	...
	public void testCreatesNextDate13() throws Throwable {
	    NextDate nextDate0 = new NextDate(70, 70, 70);
	    String string0 = nextDate0.run(6, 6, 1879);
	    assertEquals("6/7/1879", string0);
	}
	...
	public void testCreatesNextDate11() throws Throwable {
	    ...
	    String string0 = nextDate0.run(5, 5, 1899);
	    assertEquals("5/6/1899", string0);
	}
